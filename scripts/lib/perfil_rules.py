...
e rating.py (perfil sugerido por tipo de cota × risco).
"""
...
# Perfil sugerido = TIPO_COTA × CATEGORIA_RISCO → PERFIL.
...
# Matriz de alinhamento cliente × fundo (0–100), usada em match.py.
...
def score_perfil(perfil_cliente: str, perfil_fundo: str) -> float:
    """Score de alinhamento perfil cliente × perfil fundo (0–100)."""
